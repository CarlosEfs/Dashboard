...
with st.expander("❓ Como usar os filtros"):
    st.markdown("""
    ## 🎯 **FILTROS SUPER SIMPLES:**
    
    ### **1. Na barra lateral, você tem:**
    - **📅 Filtro de Mês:** Escolha quais meses quer ver
    - **📊 Filtro de Categoria:** Selecione as categorias
    - **👤 Filtro de Gerente:** Filtre por gerente
    - **🌐 Filtro de Site:** Escolha os sites
    
    ### **2. Como funciona:**
    - **Selecione** os itens que quer VER
    - **Desmarque** os que quer ESCONDER
    ...
    - **Nome do arquivo CSV** reflete os filtros aplicados
